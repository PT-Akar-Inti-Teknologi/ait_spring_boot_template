...
public class OrderCoreImpl implements OrderCore {
  ...
  public ResponseEntity<ResponseTemplate<ResponseDetail<OrderRes>>> addOrder(OrderReq orderReq) {
    ...
    return responseHelper.createResponseDetail(ResponseEnum.SUCCESS,
        orderTransform.createOrderResponse(addOrder));
  }

  @Override
  public ResponseEntity<ResponseTemplate<ResponseDetail<OrderRes>>> submitOrder(String id,
                                                                                OrderReq orderReq) {
    Order order = orderTransform.mappingOrderFromOrderReq(orderReq);
  ...
  @Override
  public ResponseEntity<ResponseTemplate<ResponseDetail<String>>> payOrder(String id,
                                                                           OrderReq orderReq) {
