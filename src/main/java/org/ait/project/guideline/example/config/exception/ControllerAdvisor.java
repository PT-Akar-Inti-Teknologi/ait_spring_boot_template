...
public class ControllerAdvisor {
  ...
  public ResponseEntity<ResponseTemplate<ResponseError>> handleMethodArgumentNotValid(
    ...
    Arrays.stream(ex.getStackTrace()).limit(5).forEach(stackTraceElement -> log.error(stackTraceElement.toString()));
    log.error(ex.getMessage());
