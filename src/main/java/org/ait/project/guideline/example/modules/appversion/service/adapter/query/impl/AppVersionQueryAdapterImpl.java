...
public class AppVersionQueryAdapterImpl implements AppVersionQueryAdapter {
  ...
  public AppVersion getAppVersion(String version, String platform) {
    return appVersionRepository.findByVersionAndPlatformIgnoreCase(version, platform)
  ...
  public AppVersion getLastVersion(String platform) {
    List<ProjectionsVersion> versions =
        appVersionRepository.findVersionByPlatformIgnoreCase(platform);
    if (versions.isEmpty()) {
