...
public class OrderController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ResponseTemplate<ResponseDetail<OrderRes>>> addOrder(@Valid @RequestBody OrderReq orderReq) {
        return orderCore.addOrder(orderReq);
    }
    
    @Operation(summary = "API to submit order")
    @PutMapping("/submit/{id}")
    public ResponseEntity<ResponseTemplate<ResponseDetail<OrderRes>>> submitOrder(@PathVariable("id") String id,@Valid @RequestBody OrderReq orderReq) {
        return orderCore.submitOrder(id, orderReq);
    }
    
    @Operation(summary = "API to get pay order")
    @PostMapping("/pay/{id}")
    public ResponseEntity<ResponseTemplate<ResponseDetail<String>>> payOrder(@PathVariable("id") String id, @RequestBody OrderReq orderReq) {
